...
client.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/BGcjWF6/elisa3.jpg?raw=true' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me//94722477361',
                                mediaType: 1,
...
function _0x2de4() {
    const _0xca7309 = [
        ...
        'catch',
        'e\x20text.\x20Th',
        '\x20of\x20its developer 𝗞𝗮𝗻𝗶𝘀𝗵𝗸𝗮_𝘅',
        'is\x20AI\x20work',
        '1832596QZCVhJ',
        '\x20and\x20Googl',
        'AgaVJ',
...
case "ping": case "speed": { 
 ...
 case "runtime": { 
                 m.reply (`Queen Tharu has been running for ${runtime(process.uptime())}`) 
 } 
 break;
